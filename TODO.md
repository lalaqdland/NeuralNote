...
- [ ] **1.2.2** 数据库模型实现
  - [ ] 实现 users 用户表模型
  - [ ] 实现 knowledge_graphs 知识图谱表模型
  - [ ] 实现 memory_nodes 记忆节点表模型
  - [ ] 实现 node_tags 标签关联表模型
  - [ ] 实现 node_relations 关联表模型
  - [ ] 实现 review_logs 复习记录表模型
